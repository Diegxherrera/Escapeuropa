...
let texto_siguiente = setInterval("comprobar_escribir('Hola hoy vas a hacer un laboratorio, debes estar a la altura, coge tus cosas que te vienes conmigo.',1,texto_siguiente)", 100)
let texto_siguiente2 = setInterval("comprobar_escribir('¿Que donde están los demas?',2,texto_siguiente2)", 100)
...
let texto_siguiente5 = setInterval("comprobar_escribir('En fin te comento ¿Ves ese ordenador de ahí?',5,texto_siguiente5)", 100)
let texto_siguiente6 = setInterval("comprobar_escribir('trrr trrr.... pum',6,texto_siguiente6)", 100)
let texto_siguiente7 = setInterval("comprobar_escribir('- Miras al ordenador y sin siquiera darte tiempo a pestañear, roberto había tirado el ordenador al suelo....',7,texto_siguiente7)", 100)
let texto_siguiente8 = setInterval("comprobar_escribir('Debes arreglarlo, este es tu trabajo de hoy, no vas a poder salir hasta que termines de arreglarlo, ... no me mires con esa cara, tus padres ya están al corriente, te aviso en cuanto me vaya no preguntes nada o tendras un cero, ¿Tienes alguna duda antes de que me vaya?  ',8,texto_siguiente8)", 100)
let texto_siguiente9 = setInterval("comprobar_escribir('¿Ninguna verdad?; Pues empieza. ',9,texto_siguiente9)", 100)